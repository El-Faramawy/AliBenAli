...
@section('site_content')
    <div class="doctor-profile   pb-5">
        ...
        <div class="container">
            ...
            <form method="post" action="{{route('store_offer_reservation')}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="additional-informations mt-4  ">
                    ...
                    <div class="row pt-4">
                        ...
                        <div class="col-lg-6 col-md-8 ">
                            <div class="form-group">
                                <label for="image"> <span class="flaticon-medal"><i class="fal fa-paperclip"></i></span>{{trans('upload_file')}}</label>
