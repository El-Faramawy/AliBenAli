...
<div class="card mb-5 mb-xl-8 mt-10">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bolder fs-3 mb-1">معرضنا</span>
        </h3>
    ...
    <div class="card-body py-3">
        ...
        <div class="table-responsive">
            ...
            <table id="kt_datatable_example_5" class="table align-middle gs-0 gy-4">
                ...
                <!--begin::Table body-->
                <tbody>
                @foreach($show_about_sliders as $show_about_slider)
                    <tr>
                        ...
                        <div class="align-items-center">
                            <div class="symbol symbol-50px me-5">
								<span class="symbol-label bg-light">
									<img class="h-75" onclick="window.open(this.src)" style='cursor: pointer' src={{asset($show_about_slider->icon)}}  alt="">
								</span>
                            </div>
                        </div>
                    </td>
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-3 mx-xl-15 my-3">
                <!--begin::Form-->
                <form id="kt_modal_new_card_form" class="form" action="{{route('admin/Delete_All_sliders')}}" method="post">
                    <!--begin::Input group-->
                    {{csrf_field()}}
                    <div class="d-flex flex-column mb-3 fv-row">
                        <!--begin::Label-->
                            <h4>سيتم حذف جميع الصور ! هل تريد المتابعة</h4>
                        <!--end::Label-->
                    </div>
                    <!--end::Input group-->
...
<div class="modal fade" id="delete_slider" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-3 mx-xl-15 my-3">
                <!--begin::Form-->
                <form id="kt_modal_new_card_form" class="form" action="{{route('admin/Delete_sliders')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-1">
                <!--begin::Form-->
                <form method="post" id="kt_modal_new_card_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{route('admin/Add_sliders')}}" enctype="multipart/form-data">
                    {{csrf_field()}}
