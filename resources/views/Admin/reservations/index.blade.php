...
@section('page_name') حجوزات اونلاين @endsection
@section('content')
        ...
        <div class="card card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1"> حجوزات الاونلاين <i class="fa fa-phone-alt"></i></span>
								...
								<span class="symbol-label bg-light">
									<img class="h-100" onclick="window.open(this.src)" style='cursor: pointer' src={{asset($reservation->doctor->image)}}  alt="">
                                            ...
                                            <div class="d-flex justify-content-start text-left flex-column">
                                                ...
                                                <span class="text-muted fw-bolder text-muted d-block fs-6">{{$reservation->doctor->clinic->name_ar}}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                            ...
                            <table class="table align-middle gs-0 gy-3">
								...
								<span class="symbol-label bg-light">
									<img class="h-100" onclick="window.open(this.src)" style='cursor: pointer' src={{asset($reservation->doctor->image)}}  alt="">
                                                    ...
                                                    <div class="d-flex justify-content-start text-left flex-column">
                                                        <a class="text-dark fw-bolder text-hover-primary mb-1 fs-5">{{$reservation->doctor->name_ar}}</a>
                                                        <span class="text-muted fw-bolder text-muted d-block fs-6">{{$reservation->doctor->clinic->name_ar}}</span>
                                                    </div>
                                                </div>
                                            </td>
