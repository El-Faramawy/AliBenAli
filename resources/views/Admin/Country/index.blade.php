...
<div class="card mb-5 mb-xl-8 mt-10">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bolder fs-3 mb-1">الجنسيات</span>
        </h3>
        ...
        <div class="table-responsive">
            ...
            <table id="kt_datatable_example_5" class="table align-middle gs-0 gy-4">
                ...
                <tr class="fw-bolder text-muted bg-light">
                    ...
                    <th class="wd-20p border-bottom-0">اسم الدولة بالعربي</th>
                    <th class="wd-20p border-bottom-0">اسم الدولة بالانجليزي</th>
                    <th class="min-w-200px rounded-end">حذف الصورة</th>
                </tr>
                </thead>
                <!--end::Table head-->
                <!--begin::Table body-->
                <tbody>
                @foreach($show_countries as $show_country)
                    <tr>
                        ...
                        <div class="align-items-center">
                            <div class="symbol symbol-50px me-5">
								<span class="symbol-label bg-light">
									<img class="h-75" onclick="window.open(this.src)" style='cursor: pointer' src={{asset($show_country->image)}}  alt="">
								</span>
                            </div>
                        </div>
                    </td>
                        <td>{{ $show_country->name_ar }}</td>
                        <td>{{ $show_country->name_en }}</td>
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-3 mx-xl-15 my-3">
                <!--begin::Form-->
                <form id="kt_modal_new_card_form" class="form" action="{{route('admin/Delete_All_Country')}}" method="post">
                    <!--begin::Input group-->
                    {{csrf_field()}}
                    <div class="d-flex flex-column mb-3 fv-row">
                        <!--begin::Label-->
                            <h4>سيتم حذف جميع الجنسيات ! هل تريد المتابعة</h4>
                        <!--end::Label-->
                    </div>
                    <!--end::Input group-->
...
<div class="modal fade" id="delete_slider" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-3 mx-xl-15 my-3">
                <!--begin::Form-->
                <form id="kt_modal_new_card_form" class="form" action="{{route('admin/Delete_Country')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-1">
                <!--begin::Form-->
                <form method="post" id="kt_modal_new_card_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{route('admin/Add_Country')}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="fv-row mb-5">
                        <!--begin::Label-->
                        <label class="d-block fw-bold fs-6 mb-1 required">رفع صورة البلد</label>
                        <!--end::Label-->
                        <!--begin::Image input-->
                    ...
                    <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                        <div class="row-12">
                            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                <span class="required">اضافه اسم الدولة بالعربي</span>
                            </label>
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid mb-4" placeholder="اكتب اسم الدولة بالعربي" name="name_ar" value="" autocomplete="off">
                        </div>
                        <div class="row-12">
                            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                <span class="required">اضافه اسم الدولة بالانجليزي</span>
                            </label>
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid mb-4" placeholder="اكتب اسم الدولة بالانجليزي" name="name_en" value="" autocomplete="off">
                        </div>
                    <!--begin::Actions-->
                    <div class="text-center">
                        <button type="reset" id="kt_modal_new_card_cancel" class="btn btn-white me-3" data-bs-dismiss="modal">الغاء</button>
