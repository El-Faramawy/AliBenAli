...
@section('page_name') مواعيد الاطباء @endsection
@section('content')
...
<div class="card mb-5 mb-xl-8 mt-10">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bolder fs-3 mb-1">الايام الخاصة لكل طبيب</span>
        </h3>
        ...
        <div class="table-responsive">
            ...
            <table id="kt_datatable_example_5" class="table align-middle gs-0 gy-4">
                ...
                <tr class="fw-bolder text-muted bg-light">
                    ...
                    <th>اليوم</th>
                    @if (request()->is('admin/doctors_dates'))
                        <th>الحالة</th>
                    @else
...
{{--                               @if($date->is_reserved == 'no')--}}
                               @if($date['available_hour']->count())
                                   <span class="badge badge-success">متبقي ساعات</span>
                                @else
                                    <span class="badge badge-danger">لا يوجد ساعات</span>
                                @endif
                                <br>
                        </td>
                            <td class="">
                                <a class="btn btn-icon btn-bg-light btn-primary btn-sm me-1" href="{{route('showAvailable',$doctor->id)}}" style="border-radius: 50% !important">
                    ...
                    @foreach($dates as $date)
                        @if($date->date >= date('Y-m-d H:i'))
                            ...
                            <td>
                                ...
                                <td>
                                  @foreach($date['available_hour'] as $hours)
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-3 mx-xl-15 my-3">
                <!--begin::Form-->
                <form id="kt_modal_new_card_form" class="form" action="{{route('destroy_date')}}" method="post">
                    {{csrf_field()}}
                    ...
                    <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                        ...
                        <!--end::Label-->
                        <div class="form-text text-danger mb-4">لن يستطيع المريض الوصول لهذا اليوم مجددا</div>
