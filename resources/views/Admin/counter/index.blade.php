    ...
    <div class="card mb-5 mb-xl-8 mt-10">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">يتم اختيار 4 صفوف في الصفحة الرئيسية</span>
            </h3>
            <div class="card-toolbar">
                <a href="{{route('add_new_counter')}}" class="btn btn-light-primary er fs-6 px-7 py-3 ml-2">
            ...
            <div class="table-responsive">
                ...
                <table id="kt_datatable_example_5" class="table align-middle gs-0 gy-4">
                    ...
                    @foreach($counters as $counter)
                        <tr>
                            <td><span><i class="{{$counter->icon}}"></i></span></td>
                            <td>{{$counter->title_ar}}</td>
                            <td>{{$counter->title_en}}</td>
                            <td>{{$counter->number}}</td>
                            <td class="">
{{--                                <a href="" class="btn btn-icon btn-bg-light btn-primary btn-sm me-1" style="border-radius: 50% !important"--}}
{{--                                        data-id="{{$counter->id}}"--}}
{{--                                        data-about_title_ar="{{$counter->title_ar}}"--}}
{{--                                >--}}
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-3 mx-xl-15 my-3">
                    <!--begin::Form-->
                    <form id="kt_modal_new_card_form" class="form" action="{{route('delete_counter')}}" method="post">
                        {{csrf_field()}}
